        ...
        return (
            <div id="title">
                <div className = "simple">
                    ...
                    <button className="btn btnsimple" onClick={() => this.props.onStartSimpleClick()}>SRT test</button>
                </div>
                <div id = "disc">
                    ...
                    <button className="btn btndisc" onClick={() => this.props.onStartDiscClick()}>DRT test</button>
                </div>
            </div>
        );
    }
